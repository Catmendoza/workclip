                ...
                <div class="modal-content">
                    ...
                    <div class="modal-bodyEmail">
                        <div class="box-inputs-modal">
                            ...
                            <input id="email" name="titulo1" value="{{ $datos->titulo1 }}">
                            <label for="" style="text-transform: uppercase;">Texto Habilidad</label>
                            <input id="programa" name="principal_texto1" value="{{ $datos->principal_texto1 }}" type="text">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-bodyCarrera">
                        <div class="box-inputs-modal">
                            ...
                            <label for="" style="text-transform: uppercase;">Titulo Habilidad</label>
                            <input id="programa" name="titulo2" value="{{ $datos->titulo2 }}" type="text">

                            <label for="" style="text-transform: uppercase;">Texto Habilidad</label>
                            <input id="programa" name="principal_texto2" value="{{ $datos->principal_texto2 }}" type="text">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-bodyCel">
                        <div class="box-inputs-modal">
                            ...
                            <label for="" style="text-transform: uppercase;">Titulo Habilidad</label>
                            <input id="contacto" name="titulo3" value="{{ $datos->titulo3 }}" type="text">
                            <label for="" style="text-transform: uppercase;">Texto Habilidad</label>
                            <input id="programa" name="principal_texto3" value="{{ $datos->principal_texto3 }}" type="text">
                        </div>
                    ...
                    <div class="modal-bodyEmail">
                        <div class="box-inputs-modal">
                            ...
                            <select name="aptitud1" id="apt-select">
                                <option value="{{$datos->aptitud1}}">Ninguna</option>
              ...
              <div class="modal-bodyEmail">
                  <div class="box-inputs-modal">
                      ...
                      <select name="aptitud2" id="apt-select">
                        <option value="{{$datos->aptitud2}}">Ninguna</option>
                        <option value="Capacidad de iniciativa">Capacidad de iniciativa</option>
                        <option value="Capacidad para resolver problemas">Capacidad para resolver problemas</option>
                        <option value="Trabajo en equipo">Trabajo en equipo</option>
                        <option value="Versatilidad">Versatilidad</option>
            ...
            <div class="datos-user" style="justify-content: flex-end">
                <div class="box-grid-datos">
                    ...
                    <div class="box-content-data">
                        <label for="">
                            <h6>HABILIDADES</h6>
                            <h6 id="programa2">{{ $datos->titulo2 }}</h6>
                        </label>
                        <button type="button" class="btn btn-primary" data-toggle="modal"
                    ...
                    <div class="box-content-data">
                        <label for="">
                            <h6>HABILIDADES</h6>
                            <h6 id="contacto2">{{ $datos->titulo3 }}</h6>
                        </label>
                        <button type="button" class="btn btn-primary" data-toggle="modal"
