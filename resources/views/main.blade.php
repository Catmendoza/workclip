        ...
        <div class="container-grid-post">
            <div class="content-post-main">
                ...
                @foreach ($productos->reverse() as $producto)
                    ...
                    @php
                    $usuario=DB::table("users")->find($producto->id_perfil);
                    @endphp
                    ...
                    <div class="col-md-7">
                        <div class="header-box-main">
                            ...
                            <div class="name-user-box">
                                <h4 class="textWhite">{{ $usuario->nombre }}</h4>
                                <h6 class="textWhite">{{ $usuario->programa }}</h6>
                            </div>

                            @php
                            $mes = explode("-", $producto->fecha_publi)[1];
                            $mesD;
                            $dia = explode("-", $producto->fecha_publi)[2];
                            ...
                            <div class="fecha-box">
                                <label>{{ $dia }} {{ $mesD }}</label>
                            </div>
                        </div>
                        <div class="box-main-content">
                            <div class="header-box-ppe">
                                <h6 style="color:#979797">{{ $producto->nombre_producto }}</h6>
                                <hr>
                            </div>
